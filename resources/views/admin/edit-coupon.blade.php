                ...
                <div class="col">
                    <div class="card">
                        ...
                        <div class="card-header border-0 pb-0">
                            <h3 class="mb-0 pb-0">Edit Coupon</h3>
                        </div>
                        <!-- Light table -->
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                ...
                                @endif
                                <form class="p-4" method="POST" action="{{ url('/admin/update-coupon') }}">
                                    @csrf
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="number" name="percentage_off" value="{{ $coupon->percentage_off }}"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control @error('is_active') @enderror" name="is_active">
                                            <option value="{{ $coupon->is_active ? 'active' : 'not_active' }}">
                                                {{ $coupon->is_active ? 'Active' : 'Not Active' }}</option>
